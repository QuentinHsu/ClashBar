...
Environment:
  PREPARE_MIHOMO_BINARY=1  Download/prepare mihomo for legacy bundled-core packaging.
  BUNDLE_MIHOMO_BINARY=1   Re-enable legacy bundled-core app/dmg packaging.
